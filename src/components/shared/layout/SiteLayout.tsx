...
const SiteLayout: FunctionComponent<Props> = ({ children }) => {
  return (
    <div className="flex flex-col w-full min-h-svh items-center bg-neutral-950">
      <div className="flex flex-col w-full sm:w-[1500px] px-6 sm:px-0 min-h-svh">{children}</div>
...
const Name = () => {
  ...
  return onHomepage ? (
    ...
    <Link type="internal" dest={INTERNAL_LINKS.HOME}>
      <p className="text-neutral-100 text-nowrap">bephrem.studio</p>
    </Link>
  );
};
